...
const Testimonials = () => {
  const reviews = [
    ...
    { name: "Ijanete Nunes", review: "Precisando se aposentar? Dra. Luana pode te ajudar, profissional ética e competente.", stars: 5 },
    { name: "Bita Melotti", review: "Profissional mt competente e dedicada, pessoa maravilhosa, super indico.", stars: 5 },
    { name: "Psicóloga Jaine Camargo", review: "Ótimo profissional, ética e comprtente!", stars: 5 },
    { name: "Ana Gomes", review: "Profissional maravilhosa e dedicada ❤", stars: 5 },
  ];
